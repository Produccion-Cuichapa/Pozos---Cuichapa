window.AdminUI = {
  ...
  trendPoints(item, field, days=30){
    const now = Date.now();
    ...
    return `
      ...
      ">
        ...
        <div class="well-trend-note">
          Los valores se obtienen de campos estructurados
          y del mensaje original. Los registros sin valor
          numérico no se grafican.
        </div>
      </section>
    `;
  },
