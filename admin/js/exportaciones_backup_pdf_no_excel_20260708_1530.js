window.AdminExportaciones = {
  ...
  async generarDiarioPDF(){
    const box = document.getElementById('diarioStatus');
    if(box) box.textContent = 'Para PDF: genera el Excel y en Excel usa Archivo > Exportar > Crear PDF/XPS. El PDF directo desde navegador requiere una función backend para convertir XLSX a PDF sin perder formato.';
    await this.generarDiario();
  },
