...
const UPV_LS_HISTORIAL  = 'upv_historial';
...
const UPV_DEDUP_WINDOW  = 60000;
const GPS_TIMEOUT_MS    = 35000;
...
function sincronizarPendientesUpv() {
  // TODO Fase 3: Firebase
  console.log('[UPV] sincronizarPendientesUpv pendiente');
}
function enviarReporteUpv(id) {
  // TODO Fase 3: UltraMsg / Cloud Function
  console.log('[UPV] enviarReporteUpv pendiente', id);
}
function corregirReporteUpv(id) {
  // TODO Fase 3: editHistory
  console.log('[UPV] corregirReporteUpv pendiente', id);
}
